...
public class MinerRecipeCategory implements IRecipeCategory<SimpleRecipe> {
        public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(SimpleStationsMiner.MODID,
                        "regular");
        ...
        public Component getTitle() {
                return Component.translatable("screen.simplestationsminer.recipes");
        }
